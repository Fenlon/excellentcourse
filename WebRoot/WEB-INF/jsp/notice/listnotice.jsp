...
<%@ taglib uri="/WEB-INF/dph.tld" prefix="dph"%>
	...
	<div id="container">
		...
		<table class="noticetable" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td></td>
				<td></td>
				<td><dph:permission value="发布公告">
						<a
							href="${pageContext.request.contextPath }/servlet/NoticeServlet?method=addUI">发布公告</a>
					</dph:permission></td>
			</tr>
			<tr>
				<td>标题</td>
			...
			<c:forEach var="n" items="${requestScope.pagebean.list }">
				<tr>
					...
					<td><dph:permission value="修改公告">
							<a
								href="${pageContext.request.contextPath }/servlet/NoticeServlet?method=updateUI&id=${n.id }">修改</a>
						</dph:permission>&nbsp; <dph:permission value="删除公告">
							<a
								href="${pageContext.request.contextPath }/servlet/NoticeServlet?method=delete&id=${n.id }">删除</a>
						</dph:permission> &nbsp; <a
						href="${pageContext.request.contextPath }/servlet/NoticeServlet?method=detail&id=${n.id }">查看</a>
					</td>
				</tr>
			</c:forEach>
		</table>
